...
In simple mathematical terms, world models learns a function $$ F: S_t x A→ S_{t+1} $$ or predicting the next state given the observed state(s) and current action.
