...
Holland writes: 
> “an internal model allows a system to look ahead to the future consequences of current actions, **without** actually committing itself to those actions” (Holland, 1992, p25).
